      ...
      addCommands(
         ...
         new SelectCommand(Map.ofEntries(
            Map.entry("1R", 
               ...
               m_robotDrive.createCommandForTrajectory(trajectory1R, true).withTimeout(15).withName("GalacticSearch1R")),
            Map.entry("1B", 
               // Reset robot pose to the beginning of 1B and Run it
               m_robotDrive.createCommandForTrajectory(trajectory1R, true).withTimeout(15).withName("GalacticSearch1B")),
            Map.entry("2R", 
               // Reset robot pose to the beginning of 2R and Run it
               m_robotDrive.createCommandForTrajectory(trajectory1R, true).withTimeout(15).withName("GalacticSearch2R")),
            Map.entry("2B", 
               // Reset robot pose to the beginning of 2B and Run it
               m_robotDrive.createCommandForTrajectory(trajectory1R, true).withTimeout(15).withName("GalacticSearch2B"))),
         i)
      );
   }
}